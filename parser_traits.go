...
var (
	genericAccepts = []string{GenericAccept}
)
...
func (t Trait) Parse(p ASTParser, name string, traits *data.Object) (*data.Object, error) {
	args, lit, err := p.ParseTraitArgs()
	if err != nil {
		return traits, err
	}
	if lit != nil {
		return p.WithTrait(traits, t.ns+name, lit), nil
	}
	if args.Length() == 0 {
		return p.WithTrait(traits, t.ns+name, data.NewObject()), nil
	}
	return p.WithTrait(traits, t.ns+name, args), nil
}
...
func (t TraitGeneric) Parse(p ASTParser, name string, traits *data.Object) (*data.Object, error) {
	args, lit, err := p.ParseTraitArgs()
	if err != nil {
		return traits, err
	}
	...
	if lit != nil {
		return p.WithTrait(traits, tid, lit), nil
	}
	return p.WithTrait(traits, tid, args), nil
}
...
func (t TraitMarker) Parse(p ASTParser, name string, traits *data.Object) (*data.Object, error) {
	return p.WithTrait(traits, t.ns+name, data.NewObject()), nil
}
...
func (t TraitString) Parse(p ASTParser, name string, traits *data.Object) (*data.Object, error) {
	...
	if t.comments {
		traits, _ = p.WithCommentTrait(traits, t.ns, s)
		return traits, nil
	}

	return p.WithTrait(traits, t.ns+name, s), nil
}
...
func (t TraitInt) Parse(p ASTParser, name string, traits *data.Object) (*data.Object, error) {
	err := p.Expect(OPEN_PAREN)
	if err != nil {
		return traits, err
	}
	...
	return p.WithTrait(traits, t.ns+name, n), nil
}
...
func (t TraitTag) Parse(p ASTParser, name string, traits *data.Object) (*data.Object, error) {
	_, tags, err := p.ParseTraitArgs()
	return p.WithTrait(traits, t.ns, tags), err
}
...
func (t TraitWithArgs) Parse(p ASTParser, name string, traits *data.Object) (*data.Object, error) {
...
func (t TraitWithLiteral) Parse(p ASTParser, name string, traits *data.Object) (*data.Object, error) {
...
func (t TraitDeprecated) Parse(p ASTParser, name string, traits *data.Object) (*data.Object, error) {
